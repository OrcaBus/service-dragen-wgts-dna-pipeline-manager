...
# Part 1: Download high-conf truth sets
# Downloads
...
# Part 2: Download and prepare the VCFs
# Dragen data
...
# Step 3: Run som.py to compare Dragen VCF to truth set
